...
terraform {
  ...
  backend "s3" {
    bucket = "devtechai-terraform-state"
...
variable "app_name" {
  ...
  type        = string
  default     = "devtechai-webapp"
}

variable "domain_name" {
  description = "Domain name for the application"
  type        = string
  default     = "devtechai.org"
}
...
resource "aws_elasticache_replication_group" "main" {
  ...
  description                = "Redis cluster for DevTechAI WebApp"
